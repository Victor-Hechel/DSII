...
get '/protected/existeComunicador/:nome' do
	dao = ComunicadorDAO.new
	retorno = 'false'
	if dao.existe(params['nome'].to_s).to_i == 1
		retorno = 'true'
	end
	return retorno
end

get '/protected/existePrograma/:nome' do
	dao = ProgramaDAO.new
	retorno = 'false'
	if dao.existe(params['nome'].to_s).to_i == 1
		retorno = 'true'
	...
	puts '-------------------\n'
	puts dao.existe(params['nome'].to_s)
	puts retorno
	return retorno
end
...
post '/protected/excluirComunicador/:id' do
	dao = ComunicadorDAO.new
